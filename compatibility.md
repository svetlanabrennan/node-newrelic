...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.846.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.846.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.846.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.846.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.846.0 | 8.7.1 |
| `@aws-sdk/smithy-client` | 3.47.0 | 3.374.0 | 8.7.1 |
| `@azure/functions` | 4.7.0 | 4.7.2 | 12.18.0 |
| `@elastic/elasticsearch` | 7.16.0 | 9.0.3 | 11.9.0 |
| `@google/genai` | 1.1.0 | 1.9.0 | 12.21.0 |
| `@grpc/grpc-js` | 1.4.0 | 1.13.4 | 8.17.0 |
| `@hapi/hapi` | 20.1.2 | 21.4.0 | 9.0.0 |
| `@koa/router` | 11.0.2 | 13.1.1 | 3.2.0 |
| `@langchain/core` | 0.1.17 | 0.3.64 | 11.13.0 |
| `@nestjs/cli` | 9.0.0 | 11.0.7 | 10.1.0 |
| `@opensearch-project/opensearch` | 2.1.0 | 3.5.1 | 12.10.0 |
| `@prisma/client` | 5.0.0 | 6.12.0 | 11.0.0 |
| `@smithy/smithy-client` | 2.0.0 | 4.4.7 | 11.0.0 |
...
| `next` | 13.4.19 | 15.4.1 | 12.0.0 |
| `openai` | 4.0.0 | 5.10.0 | 11.13.0 |
