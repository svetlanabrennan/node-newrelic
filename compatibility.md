...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.988.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.988.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.988.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.988.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.988.0 | 8.7.1 |
| `@aws-sdk/smithy-client` | 3.47.0 | 3.374.0 | 8.7.1 |
| `@azure/functions` | 4.7.0 | 4.11.2 | 12.18.0 |
| `@elastic/elasticsearch` | 7.16.0 | 9.3.1 | 11.9.0 |
| `@google/genai` | 1.1.0 | 1.40.0 | 12.21.0 |
| `@grpc/grpc-js` | 1.4.0 | 1.14.3 | 8.17.0 |
| `@hapi/hapi` | 20.1.2 | 21.4.4 | 9.0.0 |
| `@koa/router` | 12.0.1 | 15.3.0 | 3.2.0 |
| `@langchain/aws` | 1.0.0 | 1.2.2 | 13.8.0 |
| `@langchain/core` | 0.2.0 | 1.1.22 | 11.13.0 |
| `@langchain/langgraph` | 1.0.0 | 1.1.4 | 13.12.0 |
| `@langchain/openai` | 1.0.0 | 1.2.7 | 11.13.0 |
...
| `@prisma/client` | 5.0.0 | 7.4.0 | 11.0.0 |
| `@smithy/smithy-client` | 2.0.0 | 4.11.3 | 11.0.0 |
...
| `mysql2` | 2.0.0 | 3.17.0 | 1.32.0 |
| `next` | 13.4.19 | 16.1.6 | 12.0.0 |
| `openai` | 4.0.0 | 6.21.0 | 11.13.0 |
