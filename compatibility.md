...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.1011.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.1011.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.1011.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.1011.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.1011.0 | 8.7.1 |
| `@aws-sdk/smithy-client` | 3.47.0 | 3.374.0 | 8.7.1 |
| `@azure/functions` | 4.7.0 | 4.11.2 | 12.18.0 |
| `@elastic/elasticsearch` | 7.16.0 | 9.3.4 | 11.9.0 |
| `@google/genai` | 1.1.0 | 1.46.0 | 12.21.0 |
...
| `@langchain/core` | 0.2.0 | 1.1.33 | 11.13.0 |
| `@langchain/langgraph` | 1.0.0 | 1.2.3 | 13.12.0 |
| `@langchain/openai` | 0.2.0 | 1.3.0 | 11.13.0 |
...
| `@smithy/smithy-client` | 2.0.0 | 4.12.6 | 11.0.0 |
...
| `next` | 13.4.19 | 16.1.7 | 12.0.0 |
| `openai` | 4.0.0 | 6.32.0 | 11.13.0 |
