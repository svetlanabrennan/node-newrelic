...
| `@apollo/server` | 4.0.0 | 5.3.0 | `@newrelic/apollo-server-plugin@2.1.0` |
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.972.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.972.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.972.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.972.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.972.0 | 8.7.1 |
| `@aws-sdk/smithy-client` | 3.47.0 | 3.374.0 | 8.7.1 |
| `@azure/functions` | 4.7.0 | 4.11.0 | 12.18.0 |
| `@elastic/elasticsearch` | 7.16.0 | 9.2.0 | 11.9.0 |
| `@google/genai` | 1.1.0 | 1.38.0 | 12.21.0 |
| `@grpc/grpc-js` | 1.4.0 | 1.14.3 | 8.17.0 |
| `@hapi/hapi` | 20.1.2 | 21.4.4 | 9.0.0 |
| `@koa/router` | 12.0.1 | 15.2.0 | 3.2.0 |
| `@langchain/aws` | 1.0.0 | 1.2.1 | 13.8.0 |
| `@langchain/core` | 0.2.0 | 1.1.16 | 11.13.0 |
| `@langchain/openai` | 1.0.0 | 1.2.3 | 11.13.0 |
| `@modelcontextprotocol/sdk` | 1.13.0 | 1.25.3 | 13.2.0 |
| `@nestjs/cli` | 9.0.0 | 11.0.16 | 10.1.0 |
| `@opensearch-project/opensearch` | 2.1.0 | 3.5.1 | 12.10.0 |
| `@prisma/client` | 5.0.0 | 7.3.0 | 11.0.0 |
| `@smithy/smithy-client` | 2.0.0 | 4.10.11 | 11.0.0 |
