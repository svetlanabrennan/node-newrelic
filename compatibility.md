...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.952.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.952.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.952.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.952.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.952.0 | 8.7.1 |
...
| `@koa/router` | 12.0.1 | 15.1.0 | 3.2.0 |
| `@langchain/core` | 0.1.17 | 1.1.5 | 11.13.0 |
| `@modelcontextprotocol/sdk` | 1.13.0 | 1.25.0 | 13.2.0 |
| `@nestjs/cli` | 9.0.0 | 11.0.14 | 10.1.0 |
| `@opensearch-project/opensearch` | 2.1.0 | 3.5.1 | 12.10.0 |
| `@prisma/client` | 5.0.0 | 7.1.0 | 11.0.0 |
| `@smithy/smithy-client` | 2.0.0 | 4.10.0 | 11.0.0 |
...
| `next` | 13.4.19 | 16.0.10 | 12.0.0 |
| `openai` | 4.0.0 | 6.13.0 | 11.13.0 |
