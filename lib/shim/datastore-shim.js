 ...
 */
function captureInstanceAttributes(host, port, database, segment, config, datastore) {
  ...
  const attributes = _normalizeParameters(
    // this,
 ...
 */
function _normalizeParameters(parameters, config, datastore) {
