...
module.exports = {
  /**
   * Region name for the request
   * @example eu-west-1
   */
  ATTR_AWS_REGION: 'aws.region',

  /**
   * Deprecated
   * {@link ATTR_DB_NAMESPACE} is newer and should be used instead.
   * Name of the database (schema) being accessed.
   */
  ATTR_DB_NAME: 'db.name',

  /**
   * Name of the database, fully qualified within the server address and port.
   */
   ...
   *
   * Deprecated
   * {@link ATTR_DB_OPERATION_NAME} is newer and should be used instead.
   * @example select
   ...
   *
   * Deprecated
   * {@link ATTR_DB_SYSTEM_NAME} is newer and should be used instead.
   * @example mysql
   ...
   *  @example ['Users', 'Cats']
   */
  ATTR_DYNAMO_TABLE_NAMES: 'aws.dynamodb.table_names',
   ...
   * deprecated
   * {@link ATTR_MONGODB_COLLECTION} is newer and should be used instead.
   */
