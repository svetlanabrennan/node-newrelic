...
function TraceSegment(
  { id, config, name, collect, parentId, root, isRoot = false },
 ...
 * only since these will get assigned when constructing Spans from segment.
 *
 ...
 */
TraceSegment.prototype.addSpanEvent = function addSpanEvent(spanEvent) {
